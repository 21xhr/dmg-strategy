# Render Production and Staging Setup
...
| Render subdomain | https://dmg-api.onrender.com | use service default subdomain (no custom domain configured) |
| APP_ENV | production | staging |
| DATABASE_URL | Production environment secret | Staging environment secret |
| MIGRATION_DATABASE_URL | Production environment secret | Staging environment secret |
