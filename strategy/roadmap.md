...
- continue with one browser-side action surface that consumes the already-exported push or challenge-lifecycle artifacts directly, or the next admin or operator action surface if browser work remains blocked
